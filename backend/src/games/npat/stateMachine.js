export const GAME_STATES = {
  ...
  STARTING: 'STARTING',
  IN_ROUND: 'IN_ROUND',
  /** @deprecated Persisted legacy; hydrated as BETWEEN_ROUNDS */
  ROUND_ENDING: 'ROUND_ENDING',
  /** Final batch AI scoring after the last answer is locked (not between rounds) */
...
export function canTransition(from, to, ctx = {}) {
  ...
  switch (from) {
    ...
    case GAME_STATES.IN_ROUND:
      ...
      return (
        to === GAME_STATES.ROUND_ENDING ||
        to === GAME_STATES.EVALUATING ||
        to === GAME_STATES.FINISHED
      );
    case GAME_STATES.ROUND_ENDING:
      return to === GAME_STATES.BETWEEN_ROUNDS || to === GAME_STATES.EVALUATING || to === GAME_STATES.FINISHED;
    case GAME_STATES.EVALUATING:
      return to === GAME_STATES.FINISHED;
