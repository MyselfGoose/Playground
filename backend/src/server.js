...
/**
 * @param {{ server: import('node:http').Server, logger: import('pino').Logger, timeoutMs?: number }} params
 */
export function setupGracefulShutdown({ server, logger, timeoutMs = 10_000 }) {
